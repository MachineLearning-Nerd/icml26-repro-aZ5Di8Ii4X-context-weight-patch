...
Through the explicit-audit winner, formal Hugging Face CPU work totals about
4h14m wall clock including failed/cancelled routes; the frozen local baseline
took 15s. Hugging Face billing cost is not exposed by `orx` logs, so no dollar
amount is estimated. No GPU was used.
...
- Winning evidence branch:
  [`orx/explicit-bfloat16-matrix-materialization-audit`](https://github.com/MachineLearning-Nerd/icml26-repro-aZ5Di8Ii4X-context-weight-patch/tree/orx/explicit-bfloat16-matrix-materialization-audit)
- Winning evidence commit: `d48d20beaca320fbae5bec711eb0da57d9a5f084`
- Winning run: `43ddff00-0937-4e16-b753-6427956d1665`
- Compute: Hugging Face `cpu-upgrade`, 23m09s for the cumulative winning run
- Seed base: `20260723`
- GPU used: no
- [Scientific command ledger](command-ledger.md)

The release candidate preserves the exact judged Space revision
`e85dfc7775923513936705737b393955303db5f4` additively. Publication remains
blocked on explicit user approval; this report does not claim a new judge
score.
